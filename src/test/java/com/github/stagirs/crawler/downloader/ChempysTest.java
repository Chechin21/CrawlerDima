...
public class ChempysTest extends Chempys {
    ...
    public void recordTest() throws IOException {
        ...
        assertEquals(record.getTitle(), "Моделирование аэротермодинамических характеристик виртуального прототипа перспективного сверхзвукового авиалайнера на крейсерском режиме полета");
        assertEquals(record.getUrl(), "http://chemphys.edu.ru/media/published/Zhelez_2017_5_corr1.pdf");
